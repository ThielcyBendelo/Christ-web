    ...
    },
{
  ...
  return (
    <>
      <nav className="fixed top-7 left-0 right-0 backdrop-bleu z-40 border-b border-bleu-700/30">
        <div className="max-w-10xl mx-auto px-4 sm:px-6 lg:px-6">
          <div className="flex justify-between h-16 items-center">
            {/* Logo */}
            <div
              className="flex items-center gap-3 cursor-pointer hover:opacity-0 transition-opacity"
              onClick={() => {
                navigate('/');
                setIsOpen(false);
              }}
            >
              ...
              <span className="text-4xl md:font-bold mb-4 bg-gradient-to-r from-blue-600 via-blue-500 to-green-500 text-transparent bg-clip-text">
                Ir Christ
              </span>
            </div>
