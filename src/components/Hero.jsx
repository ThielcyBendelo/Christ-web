...
export default function Hero() {
  ...
  return (
    <section
      ref={elementRef}
      id="home"
      className="relative min-h-screen flex flex-col justify-left-center mt-5 items-center text-center px-6 pt-20 overflow-hidden"
    >
      ...
      <div className="relative z-20">
          ...
          <div className="mb-10 flex justify-center">
            ...
            >
              <LazyImage
                ...
                className="w-48 h-48 md:w-64 md:5 rounded-full object-cover border-4 border-purple shadow-neon-purple relative z-10"
                priority={true}
                placeholder={
                  <div className="w-48 h-48 md:w-64 md:h-64 rounded-full bg-gradient-to-r from-purple to-pink animate-pulse border-4 border-purple mt-5" />
                }
              />
        ...
        <AnimatedSection variant="slideUp" delay={0.4}>
          <div className="mb-8 text-center">
            <motion.h2
              className="text-2xl md:text-4xl font-bold mb-3 bg-gradient-to-r from-blue-600 via-blue-500 to-green-500 text-transparent bg-clip-text"
              animate={{
            ...
            >
              Salut! Je suis Il Christ Business,
            </motion.h2>
            ...
            >
              Ingénieur en Réseaux Informatiques & Systèmes, spécialisé en IT support. 
            </motion.p>
